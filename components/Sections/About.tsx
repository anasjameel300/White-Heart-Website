      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-2 gap-20 lg:gap-32 items-center">
        ...
        <div className={isRTL ? 'order-1 text-right' : 'text-left'}>
          <Reveal delay={0.3} variant="slide" direction={isRTL ? 'left' : 'right'}>
            ...
            <h3 className="font-serif text-5xl md:text-6xl text-brand-dark mb-10 leading-[1.2] tracking-tight break-words">
              {isRTL ? (
            ...
            <p className="font-sans text-brand-dark/70 text-lg md:text-xl leading-relaxed mb-8 max-w-xl break-words">
              {isRTL
